...
class EnvironmentScreen extends React.Component {
							...
							if(rowData.env == 'Independent'){
								return(
									<View style={styles.usersContainer}>
										...
										<Text style={labels.style}>{rowData.env+""}</Text>
									</View>	
								);
							}
								...
								return(
									<View style={styles.headerContainer}>
										<Text style={labels.style}>Unknown Environment</Text>
									</View>
								);
							}
						}}
	...
	fetchOnlineData(){
		return fetch('http://reaching4english-001-site1.itempurl.com/Environment/envQuery.php')
