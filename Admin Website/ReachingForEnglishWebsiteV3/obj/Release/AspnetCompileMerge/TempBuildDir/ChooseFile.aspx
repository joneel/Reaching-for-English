<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChooseFile.aspx.cs" Inherits="ReachingForEnglishWebsiteV3.ChooseFile" %>
...
<body>
    <form id="form1" runat="server">
        <p style="height: 75px; width: 100%">
            <asp:Label runat="server" Text="Select File to Upload" Font-Size="40" style="position:fixed; left:37%; z-index: 1; top: 15px; width: 70%;">
            </asp:Label>
        </p>
        <p style="height: 75px; width: 100%">
